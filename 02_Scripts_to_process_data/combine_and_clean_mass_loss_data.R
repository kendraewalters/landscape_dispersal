# Combine datasets for mass loss data (I know there's a lot)
# Kendra E Walters
# August 14th 2020
...
# Set our working directory and output 
setwd("~/Google Drive/Dispersal_Ch_3/03_GitHub_Data_and_Scripts/01_Raw_data/02_Mass_Loss/")
output.data <- "~/Google Drive/Dispersal_Ch_3/03_GitHub_Data_and_Scripts/03_Processed_data/mass_loss_cleaned.csv"
...
initial.meta <- merge(initial.litter.weights, metadata.together, by = "Old_Sample_ID", all.x = TRUE)
